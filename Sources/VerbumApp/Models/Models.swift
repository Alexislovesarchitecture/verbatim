...
struct SeedData {
    static let dictionary: [DictionaryEntry] = [
        .init(source: "verbum", replacement: "Verbum", learnedAutomatically: true),
    ...
    static let notes: [NoteItem] = [
        .init(title: "Verbum MVP", body: "Finish the function-key loop, clipboard fallback, and floating listening capsule before adding aggressive AI cleanup."),
