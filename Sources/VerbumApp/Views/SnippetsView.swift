            ...
            GroupBox {
                VStack(alignment: .leading, spacing: 12) {
                    Text("The stuff you should not have to retype")
                        .font(.title2)
                    Text("Speak a trigger phrase and Verbum expands it instantly. Keep this deterministic at first. Static snippets give you most of the value before you add variables or AI transforms.")
