...
final class SettingsViewModel: ObservableObject {
    ...
    func syncFromStored() {
        ...
        openAIModel = settings.openAIModel ?? .gpt4oMiniTranscribe
        whisperCppPath = settings.whisperCppPath
        whisperModelPath = settings.whisperModelPath
        whisperBackend = settings.whisperBackend ?? .server
        whisperModelId = settings.whisperModelId ?? WhisperLocalModel.defaultId.rawValue
        whisperModelsDir = settings.whisperModelsDir ?? WhisperModelDirectory.defaultPath
        whisperServerAutoStart = settings.whisperServerAutoStart ?? true
        whisperLocalThreads = settings.whisperLocalThreads ?? 4
