...
9. Drag the `Sources/Verbatim` folder into your project navigator.
...
14. When prompted, grant Accessibility permission so Verbatim can insert text into other apps.
