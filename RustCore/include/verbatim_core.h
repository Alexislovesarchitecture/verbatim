...
char *verbatim_core_resolve_selection(void *engine, const char *request_json);
char *verbatim_core_resolve_provider_model_selection(void *engine, const char *request_json);
char *verbatim_core_build_history_sections(void *engine, const char *request_json);
char *verbatim_core_reduce_provider_diagnostics(void *engine, const char *request_json);
