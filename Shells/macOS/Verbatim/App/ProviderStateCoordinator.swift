...
enum ProviderStateCoordinator {
    static func refresh(
        ...
        for (providerID, provider) in providers {
            ...
            readiness[providerID] = await provider.readiness(for: normalizedSettings.preferredLanguage(for: providerID))
        }
        ...
        let capabilityResolution = sharedCore.resolveCapabilities(
            ...
            storedProvider: normalizedSettings.selectedProvider,
        ...
        let selectionResolution = sharedCore.resolveSelection(
            ...
            preferredLanguages: normalizedSettings.preferredLanguages,
        ...
        let modelSelectionResolution = sharedCore.resolveProviderModelSelection(
            selectedProvider: normalizedSettings.selectedProvider,
            selectedWhisperModelID: normalizedSettings.selectedWhisperModelID,
            selectedParakeetModelID: normalizedSettings.selectedParakeetModelID,
